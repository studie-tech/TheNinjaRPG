 ...
 *
 * Do not assign a 1x1 placeholder and mark it for upload. WebGL2 allocates
 * immutable storage on first use (`texStorage2D`); a placeholder locks the
 * GPU texture at 1x1, so trees and buildings stay as stretched white boxes

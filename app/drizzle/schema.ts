...
export const fishingSession = mysqlTable(
  "FishingSession",
  {
    ...
    engineVersion: tinyint("engineVersion", { unsigned: true }).default(1).notNull(),
    habitatId: varchar("habitatId", { length: 191 }),
    simulationState: json("simulationState").$type<Record<string, unknown>>(),
    lastInputSequence: int("lastInputSequence", { unsigned: true }).default(0).notNull(),
    version: int("version").default(1).notNull(),
